...
```ts
{
  ...
  documentType: string,        // free text, uppercased server-side. Recognized/"required" values: PAN_CARD, SALARY_SLIP, AADHAAR_CARD. Anything else (e.g. default "OTHER") is accepted but not tracked as required.
